  ...
  <body>
   <jsp:include page="head.jsp"></jsp:include>
	...
	<s:iterator value="#items" id="item">
		...
		<div class="flowercheck">价格：<s:property value="value.flower.price"/>元</div>
		<div class="flowercheck">数量：<input size="4" type="text" name="quantity" value="<s:property value="value.quantity"/>"></div>
	
		<input type="hidden" name="id" value="<s:property value="value.flower.flowerid"/>">
		...
		<div style="clear: both;"><s:form action="checkOut" method="post">
